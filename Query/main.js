            ...
            while (!isSessionCreated) {
                try {
                    ...
                    if (error.message.includes('PHONE_CODE_EXPIRED')) {
                        this.bot.sendMessage(chatId, '⚠️ The code has expired. Please request a new code.');
                    } else if (error.message.includes('PHONE_CODE_INVALID')) {
                        this.bot.sendMessage(chatId, '⚠️ The code you entered is invalid. Please try again.');
                    } else if (error.message.includes('AUTH_PASSWORD_REQUIRED')) {
                        this.bot.sendMessage(chatId, '🔑 A password is required. Please enter your password again.');
                    } else {
